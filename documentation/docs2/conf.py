...
# -*- coding: utf-8 -*-
#
# Code Inegration System documentation build configuration file, created by
# sphinx-quickstart on Wed Apr  5 03:26:38 2017.
#
...
htmlhelp_basename = 'CodeInegrationSystemdoc'
...
latex_documents = [
    (master_doc, 'CodeInegrationSystem.tex', 'Code Inegration System Documentation',
     '0x4bdn', 'manual'),
]
...
man_pages = [
    (master_doc, 'codeinegrationsystem', 'Code Inegration System Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CodeInegrationSystem', 'Code Inegration System Documentation',
     author, 'CodeInegrationSystem', 'One line description of project.',
     'Miscellaneous'),
]
